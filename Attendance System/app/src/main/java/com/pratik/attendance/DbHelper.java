...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_STATUS_TABLE=
            "CREATE TABLE "+ STATUS_TABLE_NAME +
                    ...
                    " FOREIGN KEY ("+ S_ID+")REFERENCES "+ STUDENT_NAME_KEY+"( "+S_ID+"),"+
                    " FOREIGN KEY ("+ C_ID+")REFERENCES "+ CLASS_TABLE_NAME+"( "+C_ID+")"+
                    ");";
    ...
    Cursor getDistinctMonths(long cid){
        SQLiteDatabase database= this.getReadableDatabase();
        return database.query(STATUS_TABLE_NAME,new String[]{DATE_KEY},C_ID+"="+cid,null,"substr("+DATE_KEY+",4,7)",null,null);//01.06.2023(position 4 and 7)
